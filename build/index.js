...
// Load env from the current working directory (optional)
dotenv.config();
// Load env from the repo root (optional), relative to build/ or src/
...
if (!WP_URL) {
    console.error("FATAL: missing WP_URL (set env var or .env)");
    process.exit(1);
}
if (!WP_USERNAME || !WP_APP_PASSWORD) {
    console.error("FATAL: missing WP_USERNAME / WP_APP_PASSWORD (set env vars or .env)");
    process.exit(1);
}
// Authentification
const authHeader = {
